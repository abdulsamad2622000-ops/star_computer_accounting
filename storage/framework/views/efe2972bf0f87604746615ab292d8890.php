<?php $__env->startSection('title', 'Purchase Point'); ?>
...
<script>
    const IS_ADMIN = <?php echo e(auth()->user()->role == 'admin' ? 'true' : 'false'); ?>;
</script>
...
<div class="receipt">
    ...
    <div class="meta">
        ...
        <div class="field">
            <label>Date</label>
            <input type="date" id="purchase_date" value="<?php echo e(date('Y-m-d')); ?>">
        </div>
...
<div class="history-section">
    ...
    <table class="history-table">
        ...
        <tbody id="historyBody">
            ...
            <tr>
                <td><span class="memo-badge"><?php echo e($purchase->memo_no); ?></span></td>
                <td><?php echo e(\Carbon\Carbon::parse($purchase->date)->format('d-m-Y')); ?></td>
                <td><?php echo e($purchase->vendor->name ?? '—'); ?></td>
                <td><?php echo e($purchase->vendor->contact1 ?? '—'); ?></td>
                <td><?php echo e($purchase->salesperson->name ?? '—'); ?></td>
                <td>Rs. <?php echo e(number_format($purchase->total)); ?></td>
                <td>
                    <span class="type-badge type-<?php echo e($purchase->payment_type); ?>">
                        <?php echo e(ucfirst($purchase->payment_type)); ?>

                    </span>
                </td>
                <td style="display:flex;gap:4px;align-items:center;flex-wrap:wrap">
                    <button class="print-btn"
                        onclick="openTransferModal(<?php echo e($purchase->id); ?>,'<?php echo e($purchase->memo_no); ?>')">
                        🔄 Transfer
                    </button>
                    <button class="print-btn"
                        onclick="openPurchaseReturn(<?php echo e($purchase->id); ?>,'<?php echo e($purchase->memo_no); ?>')">
                        ↩️ Return
                    </button>
                    <?php if(auth()->user()->role == 'admin'): ?>
                    <button class="print-btn" onclick="editPurchaseRate(<?php echo e($purchase->id); ?>)">✏️ Rate</button>
                    <?php endif; ?>
                    <button class="print-btn"
                        onclick="window.open('/purchases/<?php echo e($purchase->id); ?>/invoice','_blank')">
                        🖨️ Print
                    </button>
                    <a href="/purchases/<?php echo e($purchase->id); ?>/invoice/pdf"
            ...
            <div class="modal-body">
                <div class="row g-3 mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="date" id="pReturnDate" class="form-control" value="<?php echo e(date('Y-m-d')); ?>">
                    </div>
                    <div class="col-md-6">
...
const allVendors  = <?php echo json_encode($vendors  ?? [], 15, 512) ?>;
...
async function submitPurchase() {
    ...
    try {
        const res = await fetch('<?php echo e(route("purchases.store")); ?>', {
            method: 'POST',
...
async function filterHistory() {
    ...
    const res       = await fetch(`<?php echo e(route('purchases.history')); ?>?${params}`);
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\star_computer_accounting\resources\views/purchases/pos.blade.php ENDPATH**/ ?>