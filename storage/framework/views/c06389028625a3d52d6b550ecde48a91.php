...
<div class="row g-3 mb-4">
    ...
    <div class="col-md-4">
        <div class="stat-card">
            ...
            <div class="stat-value">Rs. <?php echo e(number_format($totalReceived)); ?></div>
    ...
    <div class="col-md-4">
        <div class="stat-card">
            ...
            <div class="stat-value" style="color:#ef4444">
                Rs. <?php echo e(number_format($totalBalance)); ?>
...
<div class="filter-card">
    <form method="GET" action="<?php echo e(route('reports.daily')); ?>">
        ...
        <div class="quick-btns">
            <a href="<?php echo e(route('reports.daily', ['from' => today()->format('Y-m-d'), 'to' => today()->format('Y-m-d')])); ?>"
               class="quick-btn">Today</a>
            <a href="<?php echo e(route('reports.daily', ['from' => now()->startOfWeek()->format('Y-m-d'), 'to' => today()->format('Y-m-d')])); ?>"
               class="quick-btn">This Week</a>
            <a href="<?php echo e(route('reports.daily', ['from' => now()->startOfMonth()->format('Y-m-d'), 'to' => today()->format('Y-m-d')])); ?>"
...
<div class="table-card">
    ...
    <span class="table-card-title">
        ...
        <small class="text-muted fw-normal ms-2" style="font-size:.8rem">
            <?php echo e(\Carbon\Carbon::parse($from)->format('d M')); ?>
    ...
    <div class="d-flex gap-2">
        ...
        <a href="<?php echo e(route('reports.export.excel', request()->all())); ?>"
           class="btn btn-sm btn-outline-success">
            <i class="bi bi-file-excel"></i> Excel
        </a>
        <a href="<?php echo e(route('reports.export.pdf', request()->all())); ?>"
    ...
    <tr>
        <th>
            ...
            <select onchange="filterCol(this, 0)" class="col-filter-select">
                ...
                <?php $__currentLoopData = $sales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e(\Carbon\Carbon::parse($sale->date)->format('d-m-Y')); ?>">
        ...
        <th>
            ...
            <select onchange="filterCol(this, 1)" class="col-filter-select">
                <option value="">All</option>
                <?php $__currentLoopData = $sales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($sale->memo_no); ?>"><?php echo e($sale->memo_no); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </th>
        <th>
            ...
            <select onchange="filterCol(this, 2)" class="col-filter-select">
                <option value="">All</option>
                <?php $__currentLoopData = $sales->pluck('customer.name')->filter()->unique()->sort(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <th>
            ...
            <select onchange="filterCol(this, 5)" class="col-filter-select">
                <option value="">All</option>
                <?php $__currentLoopData = $sales->flatMap->items->pluck('qty')->unique()->sort(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $qty): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <th>
            ...
            <select onchange="filterCol(this, 6)" class="col-filter-select">
                <option value="">All</option>
                <?php $__currentLoopData = $sales->flatMap->items->pluck('total')->unique()->sort(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $total): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="Rs. <?php echo e(number_format($total)); ?>">
                        Rs. <?php echo e(number_format($total)); ?>
        ...
        <th>
            ...
            <select onchange="filterCol(this, 7)" class="col-filter-select">
                <option value="">All</option>
                <?php $__currentLoopData = $sales->pluck('paid')->unique()->sort(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paid): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="Rs. <?php echo e(number_format($paid)); ?>">
                        Rs. <?php echo e(number_format($paid)); ?>
        ...
        <th>
            ...
            <select onchange="filterCol(this, 8)" class="col-filter-select">
                <option value="">All</option>
                <?php $__currentLoopData = $sales->pluck('description')->filter()->unique()->sort(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $desc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <th>
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $sales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <tr>
                        <td>
                            <?php echo e(\Carbon\Carbon::parse($sale->date)
                                ->format('d-m-Y')); ?>

                        </td>
                        <td>
                            <span class="memo-no"><?php echo e($sale->memo_no); ?></span>
                        </td>
                        ...
                        <td>
                            <button class="btn btn-sm btn-outline-primary"
                                    onclick="editTx(
                                        ...
                                        <?php echo e($sale->paid); ?>,
                                        '<?php echo e($sale->description); ?>'
                                    )">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\star_computer_accounting\resources\views/reports/daily.blade.php ENDPATH**/ ?>