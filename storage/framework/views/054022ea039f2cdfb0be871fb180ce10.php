...
<div class="row g-3 mb-4">
    ...
    <div class="col-md-3">
        <div class="stat-card">
            ...
            <div class="stat-value">Rs. <?php echo e(number_format($todayTotal)); ?></div>
...
<div class="card mb-4" style="border:2px solid #163a6f;border-radius:10px;padding:16px;background:#e7f1ff">
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:6px;font-size:12px;margin-bottom:10px">
        ...
        <div style="font-weight:700;color:#163a6f">Rs. <?php echo e(number_format($totalCash)); ?></div>

        
        <div style="color:#3e5a7a">Total Online</div>
        <div style="font-weight:700;color:#163a6f">Rs. <?php echo e(number_format($totalOnline)); ?></div>

        
        <div style="color:#3e5a7a">+ Stock Value</div>
        <div style="font-weight:700;color:#22c55e">Rs. <?php echo e(number_format($totalStockValue)); ?></div>

        
        <div style="color:#3e5a7a">+ Receivable (Customer)</div>
        <div style="font-weight:700;color:#22c55e">Rs. <?php echo e(number_format($totalReceivable)); ?></div>

        
        <div style="color:#3e5a7a">- Payable (Vendor)</div>
        <div style="font-weight:700;color:#ef4444">Rs. <?php echo e(number_format($totalPayable)); ?></div>
    ...
    <div style="border-top:2px dashed #5a7ca8;padding-top:8px;display:flex;justify-content:space-between;align-items:center">
        ...
        <span style="font-weight:900;font-size:18px;color:<?php echo e($businessBalance >= 0 ? '#163a6f' : '#ef4444'); ?>">
            Rs. <?php echo e(number_format($businessBalance)); ?>
...
<div class="row g-3 mb-4">
    ...
    <div class="col-md-4">
        <div class="stat-card">
            ...
            <div class="stat-value">
                ...
                <?php echo e(number_format($totalStockValue)); ?>
    ...
    <div class="col-md-4">
        <div class="stat-card">
            ...
            <div class="stat-value" style="color:#ef4444"><?php echo e($lowStockCount); ?></div>
...
<div class="row g-3">
    ...
    <div class="col-md-4">
        <div class="stat-card">
            ...
            <div class="stat-value"><?php echo e($todayInvoices); ?></div>
    ...
    <div class="col-md-4">
        <div class="stat-card">
            ...
            <div class="stat-value">Rs. <?php echo e(number_format($todayCash)); ?></div>
    ...
    <div class="col-md-4">
        <div class="stat-card">
            ...
            <div class="stat-value">Rs. <?php echo e(number_format($todayCredit)); ?></div>
        ...
        <div class="modal-content" style="border-radius:12px;border:none;box-shadow:0 8px 32px rgba(0,0,0,0.15)">
            ...
            <div class="modal-body p-0">
                ...
                <table class="table table-hover mb-0" style="font-size:13px">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $unsettledVendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $vendor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td class="px-3 py-2 text-muted"><?php echo e($i + 1); ?></td>
                            <td class="px-3 py-2 fw-bold"><?php echo e($vendor->name); ?></td>
                            <td class="px-3 py-2 text-muted"><?php echo e($vendor->contact1 ?? '—'); ?></td>
                            <td class="px-3 py-2">
                                <span style="color:#ef4444;font-weight:700;font-size:14px">
                                    Rs. <?php echo e(number_format($vendor->balance)); ?>
                    ...
                    <tfoot style="background:#fef2f2">
                        <tr>
                            ...
                            <td colspan="2" class="px-3 py-2 fw-bold" style="color:#ef4444;font-size:15px">
                                Rs. <?php echo e(number_format($unsettledVendors->sum('balance'))); ?>
        ...
        <div class="modal-content" style="border-radius:12px;border:none;box-shadow:0 8px 32px rgba(0,0,0,0.15)">
            ...
            <div class="modal-body p-0">
                ...
                <table class="table table-hover mb-0" style="font-size:13px">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $unsettledCustomers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td class="px-3 py-2 text-muted"><?php echo e($i + 1); ?></td>
                            <td class="px-3 py-2 fw-bold"><?php echo e($customer->name); ?></td>
                            <td class="px-3 py-2 text-muted"><?php echo e($customer->contact1 ?? '—'); ?></td>
                            <td class="px-3 py-2">
                                <span style="color:#16a34a;font-weight:700;font-size:14px">
                                    Rs. <?php echo e(number_format($customer->balance)); ?>
                    ...
                    <tfoot style="background:#f0fdf4">
                        <tr>
                            ...
                            <td colspan="2" class="px-3 py-2 fw-bold" style="color:#16a34a;font-size:15px">
                                Rs. <?php echo e(number_format($unsettledCustomers->sum('balance'))); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\star_computer_accounting\resources\views/dashboard.blade.php ENDPATH**/ ?>