                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="contact1"
                               class="form-control"
                               value="<?php echo e(old('contact1', $vendor->contact1)); ?>">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Contact 2</label>
                        <input type="text" name="contact2"
                               class="form-control"
                               value="<?php echo e(old('contact2', $vendor->contact2)); ?>">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">CNIC</label>
                        <input type="text" name="cnic"
                               class="form-control"
                               value="<?php echo e(old('cnic', $vendor->cnic)); ?>">
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="opening_balance"
                               class="form-control"
                               value="<?php echo e(old('opening_balance', $vendor->opening_balance)); ?>"
                               min="0" step="0.01">
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\star_computer_accounting\resources\views/vendors/edit.blade.php ENDPATH**/ ?>