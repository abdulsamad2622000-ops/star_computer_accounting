...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $totalCash = Sale::where('type', 'sale')
                        ...
                        ->sum('paid')
                   + CustomerPayment::where('method', 'cash')->sum('amount')
                   - VendorPayment::where('method', 'cash')->sum('amount');

        $totalOnline = Sale::where('type', 'sale')
                          ->where('payment_type', 'bank_transfer')
                          ->sum('paid')
                     + CustomerPayment::where('method', 'online')->sum('amount')
                     - VendorPayment::where('method', 'online')->sum('amount');
