...
<div class="receipt">
        ...
        <table class="header-grid" cellpadding="0" cellspacing="0">
            <tr>
                <td class="brand-col">
                    ...
                    @if($s && $s->address)
                    <div class="address">
                        <span class="addr-label">Office: </span>
                        {{ $s->address }}
                    </div>
                    @endif
                </td>
    ...
    <!-- Meta -->
    <table class="meta" cellpadding="3" cellspacing="3">
        <tr>
            <td class="meta-cell">
            ...
            <td class="meta-cell">
                ...
                <span class="meta-value">{{ $sale->customer->contact1 ?? '—' }}</span>
            </td>
            <td width="1%"></td>
            <td class="meta-cell">
                <span class="meta-label">CNIC</span>
                <span class="meta-value">{{ $sale->customer->cnic ?? '—' }}</span>
            </td>
            <td width="1%"></td>
            <td class="meta-cell">
            ...
            <td class="totals-left">
                <div class="totals-box">
                    <table width="100%" cellpadding="2" cellspacing="0">
                        ...
                        <tr class="t-row">
                            <td class="t-label"
                                style="font-weight:bold;color:#163a6f">
                                Net total
                            </td>
                            <td class="t-value"
                                style="background:#163a6f;color:#fff;
                                       font-size:12px">
                                {{ number_format($sale->total, 2) }}
                            </td>
                        </tr>
                        <tr class="t-row">
                            <td class="t-label">Received amount</td>
                            <td class="t-value">
    ...
    <table class="footer" cellpadding="0" cellspacing="0">
        <tr>
            <td class="footer-left">
                {{ $s->thank_you_message ?? 'Thank you for your business.' }}
            </td>
