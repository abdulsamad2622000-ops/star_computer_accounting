    ...
    <div class="d-flex justify-content-between align-items-start flex-wrap gap-3">
        <div class="row g-3 flex-grow-1">
            ...
            <div class="col-md-2">
                ...
                <div>{{ $customer->contact1 ?? '—' }}</div>
            </div>
            <div class="col-md-2">
                <div class="stat-label">Contact 2</div>
                <div>{{ $customer->contact2 ?? '—' }}</div>
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-2">
                ...
                <div class="memo-no">Rs. {{ number_format($customer->opening_balance) }}</div>
            </div>
        </div>
        <div class="d-flex gap-2 flex-shrink-0">
            ...
            <a href="{{ route('customers.ledger.excel', $customer) }}"
               class="btn btn-sm btn-outline-success no-print">
                <i class="bi bi-file-excel"></i> Excel
            </a>
            <form action="{{ route('customers.ledger.delete', $customer) }}"
                  method="POST"
...
<div class="table-card">
    <div class="table-card-header">
        <span class="table-card-title">
            <i class="bi bi-journal-text me-2"></i>Ledger — {{ $customer->name }}
        </span>
                ...
                <tr>
                    ...
                    <th>
                        ...
                        <select class="col-filter-select" onchange="filterLedger(this,1)">
                            <option value="">All</option>
                            @foreach($sales->pluck('memo_no')->unique() as $m)
                    ...
                    <th>
                        ...
                        <select class="col-filter-select" onchange="filterLedger(this,5)">
                            <option value="">All</option>
                            @foreach($sales->flatMap->items->pluck('qty')->unique()->sort() as $q)
                    ...
                    <th>
                        ...
                        <select class="col-filter-select" onchange="filterLedger(this,6)">
                            <option value="">All</option>
                            @foreach($sales->flatMap->items->pluck('total')->unique()->sort() as $t)
                    ...
                    <th>
                        ...
                        <select class="col-filter-select" onchange="filterLedger(this,10)">
                            <option value="">All</option>
                            @foreach($sales->flatMap->items->pluck('description')->filter()->unique()->sort() as $desc)
            ...
            <tbody>
                ...
                @foreach($sales as $sale)
                    ...
                    <tr>
                        ...
                        <td><span class="memo-no">{{ $sale->memo_no }}</span></td>
    ...
    <i class="bi bi-pencil"></i>
                ...
                <tr class="payment-row">
                    ...
                    <td>
                        ...
                        @endif
                        <form action="{{ route('customers.payment.delete', $payment) }}"
                              method="POST" class="d-inline"
...
<div class="pay-form-wrap no-print">
    ...
    <form action="{{ route('customers.payment.store', $customer) }}"
...
<script>
    ...
    const allCustomersForEdit = @json(\App\Models\Customer::orderBy('name')->get());
