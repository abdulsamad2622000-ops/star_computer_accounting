...
<head>
    ...
    <title>Star Computer — @yield('title')</title>
...
@endphp
    {{-- Dashboard --}}
    @if($isAdmin || $perms?->dashboard_access)
    ...
    {{-- Sales --}}
    @if($isAdmin || $perms?->sale_access || $perms?->purchase_access)
    <div class="nav-label">Sales</div>
    @endif

    @if($isAdmin || $perms?->sale_access)
    <div class="nav-item">
    ...
    @if($isAdmin || $perms?->purchase_access)
    <div class="nav-item">
        <a href="{{ route('purchases.pos') }}"
    ...
    {{-- Management --}}
    @if($isAdmin || $perms?->customer_access || $perms?->vendor_access || $perms?->inventory_access)
    <div class="nav-label">Management</div>
    @endif

    @if($isAdmin || $perms?->customer_access)
    <div class="nav-item">
    ...
    @if($isAdmin || $perms?->vendor_access)
    <div class="nav-item">
    ...
    @if($isAdmin || $perms?->inventory_access)
    <div class="nav-item">
    ...
    {{-- Reports --}}
    @if($isAdmin || $perms?->report_access)
    ...
    <div class="nav-item">
        <a href="{{ route('settings.business') }}"
           class="{{ request()->routeIs('settings.business*') ? 'active' : '' }}">
